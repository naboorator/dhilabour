...
`
    ...
    gatherAssets() {
        this.assetsLoader.addImage([
            ...
            './assets/images/avatar/boy/walk_up.gif',
            './assets/images/avatar/boy/walk_down.gif',
            './assets/images/avatar/boy/walk_left.gif',
            './assets/images/avatar/boy/walk_right.gif',
        ]);
        ...
        this.assetsLoader.addSound([
            ...
            './assets/sounds/music/forest.mp3',
        ]);
