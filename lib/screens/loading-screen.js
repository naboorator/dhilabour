...
`
    ...
    button = '' +
        '<p>Game is using sound, so please turn down your volume if u play in the office :)</p>' +
        '<button  class="btn" onclick="iAgree()">Okay and thanks for letting me know :)</button>';
