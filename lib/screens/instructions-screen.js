class InstructionsScreen extends BaseScreen {
    ...
    html = `
          ...
          <div class="instructions-screen">
                ...
                <div class="menu">
                  <h1>Quick info about controls</h1>
        
                    <p>
                     Controls:
                       <ul style="text-align:left">
                         <li>Arrow keys or w,s,a,d - move character</li>
                          <li>Space - interact with facing items</li>
                          <li>command or ctr - use last invetory item</li>
                       </ul>
...
`
    ...
    handleUserInput(key, avatar) {
        instructionScreenInputHandler(key)
    }
}
...
function instructionScreenInputHandler(key, menuItems) {
